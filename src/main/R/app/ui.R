...
shinyUI(navbarPage(
  ...
  tabPanel('Betting Odds',
           p(HTML('Betting odds from 22 online bookmakers for the 32 teams in the UEFA Euro 2021. 
  ...
  tabPanel('Pairwise Comparisons',
           ...
           #br(),
           p('For example see the rightmost column of the top row: the probability of Brazil beating Australia is estimated
             as 74.3 %.'),
           uiOutput("ui_heatmap")),  
  tabPanel('Bookmaker consensus rating',
           ...
           p('Bookmaker consensus rating for the UEFA Euro 2021, obtained from 22 online
