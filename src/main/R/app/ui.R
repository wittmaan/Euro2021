...
shinyUI(navbarPage(
    title = 'UEFA Euro 2021 Prediction',
    tabPanel('Explanation',
             ...
             the 24 teams of the UEFA Euro 2021.'),
             br(),
    ...
    tabPanel('Betting Odds',
             p(HTML('Betting odds from 23 online bookmakers for the 32 teams in the UEFA Euro 2021. 
              They are obtained on 2021-05-31 from <a href="https://www.oddschecker.com/football/euro-2020/winner">https://www.oddschecker.com/football/euro-2020/winner</a>')),
    ...
    tabPanel('Bookmaker consensus rating',
             ...
             p('Bookmaker consensus rating for the UEFA Euro 2021, obtained from 23 online
